...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Check.prototype, "monthId", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Check.prototype, "yearId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'decimal',
        precision: 10,
...
], Check.prototype, "checkSpentDay", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'decimal',
        precision: 10,
    ...
    (0, class_transformer_1.Transform)(({ value }) => value.toString(), { toPlainOnly: true }),
    __metadata("design:type", decimal_js_1.default)
], Check.prototype, "checkSpentNight", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'decimal',
        precision: 10,
    ...
    (0, class_transformer_1.Transform)(({ value }) => value.toString(), { toPlainOnly: true }),
    __metadata("design:type", decimal_js_1.default)
], Check.prototype, "priceDay", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'decimal',
        precision: 10,
    ...
    (0, class_transformer_1.Transform)(({ value }) => value.toString(), { toPlainOnly: true }),
    __metadata("design:type", decimal_js_1.default)
], Check.prototype, "priceNight", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'decimal',
        precision: 10,
    ...
    (0, class_transformer_1.Transform)(({ value }) => value.toString(), { toPlainOnly: true }),
    __metadata("design:type", decimal_js_1.default)
], Check.prototype, "invoiceAmount", void 0);
Check = __decorate([
    (0, typeorm_1.Entity)()
], Check);
exports.Check = Check;
//# sourceMappingURL=parsing.entity.js.map