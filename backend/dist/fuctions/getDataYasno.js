...
exports.getDataYasno = void 0;
const puppeteer_1 = require("puppeteer");
const getDataYasno = async (company) => {
    let res = {
        date: undefined,
    ...
    await page.waitForSelector('.cabinet__wrap > :nth-child(3) > :nth-child(1) > :nth-child(3) ');
    const buttonExistence = await page.$('.cabinet__wrap > :nth-child(3) > :nth-child(1) > :nth-child(3)  > :nth-child(2)');
    if (buttonExistence !== null) {
        await page.click('.cabinet__wrap > :nth-child(3) > :nth-child(1) > :nth-child(3)  > :nth-child(2)');
        await sleep(30000);
    ...
    await page.waitForSelector('.sidebar__nav > :nth-child(2) > .sidebar__nav-sub > :nth-child(1)');
    await page.click('.sidebar__nav > :nth-child(2) > .sidebar__nav-sub > :nth-child(1)');
    await page.waitForSelector('#top0 > :nth-child(6)');
    await page.click('#top0 > :nth-child(6)');
    const monthSelector = await page.waitForSelector('.basic-table__body > :nth-child(2) > :nth-child(1)');
    const month = await monthSelector?.evaluate((el) => el.textContent);
    res.date = month;
    const dataSelector = await page.waitForSelector('.basic-table__body > :nth-child(2) > :nth-child(4)');
...
exports.getDataYasno = getDataYasno;
//# sourceMappingURL=getDataYasno.js.map